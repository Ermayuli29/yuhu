...
function everly_theme_setup() {
	...
	/*lang*/
	load_theme_textdomain( 'everly', get_template_directory() . '/lang' );
	/*setting thumb size*/
	...
	register_nav_menus(array(
			...
			'everly_mainmenu' => esc_html__('Main Menu','everly'),
			'everly_respmenu' => esc_html__('Responsive Menu','everly'),	
			'everly_scrollmenu' => esc_html__('Scroll Menu','everly'),	
    ...
    register_sidebar(array(
        'id' => 'everly_sidebar',
        'name' => esc_html__('Sidebar main','everly'),
    ...
    register_sidebar(array(
        'id' => 'everly-sidebar-single',
        'name' => esc_html__('Sidebar Single page sidebar','everly'),
        'before_widget' => '<div class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3><div class="widget-line"></div>'
    ...
    register_sidebar(array(
        ...
        'name' => esc_html__('Top sidebar left','everly'),
        'before_widget' => '<div class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3>'
    ...
    register_sidebar(array(
        ...
        'name' => esc_html__('Top sidebar right','everly'),
        'before_widget' => '<div class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3>'
    ...
    register_sidebar(array(
        ...
        'name' => esc_html__('Sidebar for advert in logo area','everly'),
        'before_widget' => '<div class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3>'
    ...
    register_sidebar(array(
        ...
        'name' => esc_html__('Sidebar under header left','everly'),
        'before_widget' => '<div class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3><div class="widget-line"></div>'
    ...
    register_sidebar(array(
        ...
        'name' => esc_html__('Sidebar under header right','everly'),
        'before_widget' => '<div class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3><div class="widget-line"></div>'
    ...
    register_sidebar(array(
        ...
        'name' => esc_html__('Sidebar under header full width','everly'),
        'before_widget' => '<div class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3><div class="widget-line"></div>'
    ...
    register_sidebar(array(
        ...
        'name' => esc_html__('Sidebar above footer full width','everly'),
        'before_widget' => '<div class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3><div class="widget-line"></div>'
    ...
    register_sidebar(array(
        ...
        'name' => esc_html__('Sidebar above footer left','everly'),
        'before_widget' => '<div class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3><div class="widget-line"></div>'
    ...
    register_sidebar(array(
        ...
        'name' => esc_html__('Sidebar above footer right','everly'),
        'before_widget' => '<div class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3><div class="widget-line"></div>'
    ...
    register_sidebar(array(
        'id' => 'everly_footer1',
        'name' => esc_html__('Footer sidebar 1','everly'),
        'before_widget' => '<div class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3>'
    ...
    register_sidebar(array(
        'id' => 'everly_footer2',
        'name' => esc_html__('Footer sidebar 2','everly'),
        'before_widget' => '<div class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3>'
    ...
    register_sidebar(array(
        'id' => 'everly_footer3',
        'name' => esc_html__('Footer sidebar 3','everly'),
        'before_widget' => '<div class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3>'
...
function everly_scripts() {
	...
	wp_enqueue_script('pmc_infinity', get_template_directory_uri() . '/js/pmc_infinity.js', array('jquery') ,true,true);  	
...
function everly_breadcrumb($title = false) {
	...
	if (!is_home()) {
		if($title == false){
			...
			$breadcrumb .=  '">';
			$breadcrumb .= esc_html__('Home', 'everly');
			$breadcrumb .=  "</a> &#187; ";
		}
		if (is_single()) {
			if (is_single()) {
			...
			$breadcrumb .= esc_html__('Search results for ', 'everly') .'"<span>'.get_search_query().'</span>"';			
		} 
		else if(is_category()){
			...
			$breadcrumb .=  '<span>'.esc_html__('Archive','everly').'</span>';
		}	
		else{
			$breadcrumb .=  esc_html__('Home','everly');
		}
...
function everly_add_meta_box(){
	add_meta_box("everly_post_type", esc_attr__("Everly options",'everly'), "everly_post_type", "post", "normal", "high");	
    ...
    <div id="portfolio-category-options">
        <table cellpadding="15" cellspacing="15">		
            <tr class="videoonly" style="border-bottom:1px solid #000;">
            	<td><label><?php esc_attr_e('Video URL(*required) - add if you select video post:','everly') ?> <i style="color: #999999;"></i></label><br><input name="video_post_url" value="<?php echo esc_attr($video_post_url); ?>" /> </td>	
			</tr>		
            <tr class="linkonly" >
            	<td><label><?php esc_attr_e('Link URL - add if you select link post : ','everly') ?><i style="color: #999999;"></i></label><br><input name="link_post_url"  value="<?php echo esc_attr($link_post_url); ?>" /></td>
            </tr>				
            <tr class="audioonly">
            	<td><label><?php esc_attr_e('Audio URL - add if you select audio post ','everly') ?> <i style="color: #999999;"></i></label><br><input name="audio_post_url"  value="<?php echo esc_attr($audio_post_url); ?>" /></td>
            </tr>	
            <tr class="nooptions">
            	<td><?php esc_attr_e('No options for this post type.','everly') ?> </td>
            </tr>				
        </table>
    </div>
	<style>
...
if( !function_exists( 'everly_fallback_menu' ) )
{
	...
	function everly_fallback_menu()
	{
		...
		echo "<ul class='Everly_fallback menu'>";
		echo "<li $current><a href='".esc_url(esc_url(home_url('/')))."'>".esc_attr__('Home','everly')."</a></li>";
...
function everly_add_this_script_footer(){ 
	...
	$everly_script = '	
		"use strict"; 
		jQuery(document).ready(function($){	
			jQuery(".searchform #s").attr("value","'. esc_html__("Search and hit enter...","everly").'");	
...
add_filter( 'get_search_form', 'everly_search_form' );
	...
	foreach ( $screens as $screen ) {
		...
		add_meta_box(
			"everly_post_content", esc_attr("Everly Options","everly"), "everly_post_content",
			$screen,'side','high'
		);
	}	
	...
	function everly_post_content(){	
		...
		if (isset($everly_data["sidebar"][0])){
         ...
         <table cellpadding="15" cellspacing="0">	
			<tr>
			<td><label><?php esc_html_e('Select custom revolution slider:','everly') ?> </label>				
			<br>	
				<?php if(shortcode_exists( 'rev_slider')) {  ?>
				<select id="custom_post_rev"  name="custom_post_rev">	
				<option value="empty" <?php if($custom_post_rev == 'empty') echo 'selected'; ?>><?php esc_html_e('Empty','everly'); ?></option>	
				<?php 				
...
return '<div class="everly-read-more"><a class="more-link" href="' . get_permalink() . '">'.esc_html__('Continue reading','everly').'</a></div>';
}
...
function everly_required_plugins() {
    ...
    $plugins = array(
		...
		array(
				'name'      => esc_attr__('Clasic Editor','everly'),
				'slug'      => 'classic-editor',
				'required'  => false,
				'force_activation'   => true, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.				
			),			
		array(
				'name'      => esc_attr__('Shortcode Ultimate','everly'),
				'slug'      => 'shortcodes-ultimate',
				'required'  => false,
			),		
		array(
				'name'      => esc_attr__('Contact Form 7','everly'),
				'slug'      => 'contact-form-7',
				'required'  => false,
			),				
		array(
				'name'      => esc_attr__('MailPoet Newsletters','everly'),
				'slug'      => 'wysija-newsletters',
				'required'  => false,
			),			
		array(
				'name'      => esc_attr__('Instagram Feed','everly'),
				'slug'      => 'instagram-feed',
				'required'  => false,
			),			
		array(
				'name'      => esc_attr__('SoundCloud Shortcode','everly'),
				'slug'      => 'instagram-feed',
				'required'  => false,
			),	
    ...
    $config = array(
        'id'           => 'everly',                 // Unique ID for hashing notices for multiple instances of TGMPA.
        ...
        'strings'      => array(
            'page_title'                      => __( 'Install Required Plugins', 'everly' ),
            'menu_title'                      => __( 'Install Plugins', 'everly' ),
            'installing'                      => __( 'Installing Plugin: %s', 'everly' ), // %s = plugin name.
            'oops'                            => __( 'Something went wrong with the plugin API.', 'everly' ),
            'notice_can_install_required'     => _n_noop( 'This theme requires the following plugin: %1$s.', 'This theme requires the following plugins: %1$s.', 'everly' ), // %1$s = plugin name(s).
            'notice_can_install_recommended'  => _n_noop( 'This theme recommends the following plugin: %1$s.', 'This theme recommends the following plugins: %1$s.', 'everly' ), // %1$s = plugin name(s).
            'notice_cannot_install'           => _n_noop( 'Sorry, but you do not have the correct permissions to install the %s plugin. Contact the administrator of this site for help on getting the plugin installed.', 'Sorry, but you do not have the correct permissions to install the %s plugins. Contact the administrator of this site for help on getting the plugins installed.', 'everly' ), // %1$s = plugin name(s).
            'notice_can_activate_required'    => _n_noop( 'The following required plugin is currently inactive: %1$s.', 'The following required plugins are currently inactive: %1$s.', 'everly' ), // %1$s = plugin name(s).
            'notice_can_activate_recommended' => _n_noop( 'The following recommended plugin is currently inactive: %1$s.', 'The following recommended plugins are currently inactive: %1$s.', 'everly' ), // %1$s = plugin name(s).
            'notice_cannot_activate'          => _n_noop( 'Sorry, but you do not have the correct permissions to activate the %s plugin. Contact the administrator of this site for help on getting the plugin activated.', 'Sorry, but you do not have the correct permissions to activate the %s plugins. Contact the administrator of this site for help on getting the plugins activated.', 'everly' ), // %1$s = plugin name(s).
            'notice_ask_to_update'            => _n_noop( 'The following plugin needs to be updated to its latest version to ensure maximum compatibility with this theme: %1$s.', 'The following plugins need to be updated to their latest version to ensure maximum compatibility with this theme: %1$s.', 'everly' ), // %1$s = plugin name(s).
            'notice_cannot_update'            => _n_noop( 'Sorry, but you do not have the correct permissions to update the %s plugin. Contact the administrator of this site for help on getting the plugin updated.', 'Sorry, but you do not have the correct permissions to update the %s plugins. Contact the administrator of this site for help on getting the plugins updated.', 'everly' ), // %1$s = plugin name(s).
            'install_link'                    => _n_noop( 'Begin installing plugin', 'Begin installing plugins', 'everly' ),
            'activate_link'                   => _n_noop( 'Begin activating plugin', 'Begin activating plugins', 'everly' ),
            'return'                          => __( 'Return to Required Plugins Installer', 'everly' ),
            'plugin_activated'                => __( 'Plugin activated successfully.', 'everly' ),
            'complete'                        => __( 'All plugins installed and activated successfully. %s', 'everly' ), // %s = dashboard link.
